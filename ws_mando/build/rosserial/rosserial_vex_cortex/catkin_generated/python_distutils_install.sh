...
echo_and_run cd "/home/leo/Documents/GitHub/mando_2023/ws_mando/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/home/leo/Documents/GitHub/mando_2023/ws_mando/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/leo/Documents/GitHub/mando_2023/ws_mando/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
